...
export default function ConsciousRobotMarketing() {
  ...
  const validateForm = () => {
    ...
    else if (formData.message.trim().length < 10) formErrors.message = "Message must be at least 10 characters";
    return formErrors;
  };
    ...
    return (
        <div className="bg-gray-100 font-sans">
            ...
            <main className="container mx-auto mt-8">
                ...
                <section
                    id="cta"
                    className="bg-purple-100 p-8 rounded-lg my-16 text-center"
                >
                    <h2 className="text-3xl font-bold mb-4">
